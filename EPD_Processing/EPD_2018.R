...
resource_name <- "EPD_201801" # For EPD resources are named EPD_YYYYMM
...
# 2018.
resource_name_list <- resources_table$name[grepl("2018", resources_table$name)]
...
EPD_2018$"0403_pc_laua" <- EPD_2018$total_quantity / EPD_2018$pop21
EPD_2018 <- EPD_2018 %>%
  select(year_month,region,local_authority,pop21,total_quantity, "0403_pc_laua", rgn_pop21)

EPD_2018_Region <- EPD_2018 %>%
  group_by(region,rgn_pop21, year_month) %>%
  summarise(total_quantity = sum(total_quantity)) %>%
  rename(total_quantity_rgn = total_quantity)
EPD_2018_Region$"0403_pc_region" <- EPD_2018_Region$total_quantity_rgn / EPD_2018_Region$rgn_pop21
EPD_2018_Region <- EPD_2018_Region %>%
...
write.csv(EPD_2018, "EPD_0403_2018.csv", row.names = FALSE)
write.csv(EPD_2018_Region, "EPD_0403_2018_RGN.csv", row.names = FALSE)
