...
resource_name <- "EPD_201701" # For EPD resources are named EPD_YYYYMM
...
# 2017.
resource_name_list <- resources_table$name[grepl("2017", resources_table$name)]
...
EPD_2017$"0403_pc_laua" <- EPD_2017$total_quantity / EPD_2017$pop21
EPD_2017 <- EPD_2017 %>%
  select(year_month,region,local_authority,pop21,total_quantity, "0403_pc_laua", rgn_pop21)

EPD_2017_Region <- EPD_2017 %>%
  group_by(region,rgn_pop21, year_month) %>%
  summarise(total_quantity = sum(total_quantity)) %>%
  rename(total_quantity_rgn = total_quantity)
EPD_2017_Region$"0403_pc_region" <- EPD_2017_Region$total_quantity_rgn / EPD_2017_Region$rgn_pop21
EPD_2017_Region <- EPD_2017_Region %>%
...
write.csv(EPD_2017, "EPD_0403_2017.csv", row.names = FALSE)
write.csv(EPD_2017_Region, "EPD_0403_2017_RGN.csv", row.names = FALSE)