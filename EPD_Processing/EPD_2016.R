...
resource_name <- "EPD_201601" # For EPD resources are named EPD_YYYYMM
...
# 2016.
resource_name_list <- resources_table$name[grepl("2016", resources_table$name)]
...
EPD_2016$"0403_pc_laua" <- EPD_2016$total_quantity / EPD_2016$pop21
EPD_2016 <- EPD_2016 %>%
  select(year_month,region,local_authority,pop21,total_quantity, "0403_pc_laua", rgn_pop21)

EPD_2016_Region <- EPD_2016 %>%
  group_by(region,rgn_pop21, year_month) %>%
  summarise(total_quantity = sum(total_quantity)) %>%
  rename(total_quantity_rgn = total_quantity)
EPD_2016_Region$"0403_pc_region" <- EPD_2016_Region$total_quantity_rgn / EPD_2016_Region$rgn_pop21
EPD_2016_Region <- EPD_2016_Region %>%
...
write.csv(EPD_2016, "EPD_0403_2016.csv", row.names = FALSE)
write.csv(EPD_2016_Region, "EPD_0403_2016_RGN.csv", row.names = FALSE)