...
EPD_2020$"0403_pc_laua" <- EPD_2020$total_quantity / EPD_2020$pop21
EPD_2020 <- EPD_2020 %>%
  select(year_month,region,local_authority,pop21,total_quantity, "0403_pc_laua", rgn_pop21)

EPD_2020_Region <- EPD_2020 %>%
  group_by(region,rgn_pop21, year_month) %>%
  summarise(total_quantity = sum(total_quantity)) %>%
  rename(total_quantity_rgn = total_quantity)
EPD_2020_Region$"0403_pc_region" <- EPD_2020_Region$total_quantity_rgn / EPD_2020_Region$rgn_pop21
EPD_2020_Region <- EPD_2020_Region %>%
...
write.csv(EPD_2020, "EPD_0403_2020.csv", row.names = FALSE)
write.csv(EPD_2020_Region, "EPD_0403_2020_RGN.csv", row.names = FALSE)
