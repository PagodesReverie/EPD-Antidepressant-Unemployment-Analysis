...
resource_name <- "EPD_201501" # For EPD resources are named EPD_YYYYMM
...
# 2015.
resource_name_list <- resources_table$name[grepl("2015", resources_table$name)]
...
EPD_2015$"0403_pc_laua" <- EPD_2015$total_quantity / EPD_2015$pop21
EPD_2015 <- EPD_2015 %>%
  select(year_month,region,local_authority,pop21,total_quantity, "0403_pc_laua", rgn_pop21)

EPD_2015_Region <- EPD_2015 %>%
  group_by(region,rgn_pop21, year_month) %>%
  summarise(total_quantity = sum(total_quantity)) %>%
  rename(total_quantity_rgn = total_quantity)
EPD_2015_Region$"0403_pc_region" <- EPD_2015_Region$total_quantity_rgn / EPD_2015_Region$rgn_pop21
EPD_2015_Region <- EPD_2015_Region %>%
...
write.csv(EPD_2015, "EPD_0403_2015.csv", row.names = FALSE)
write.csv(EPD_2015_Region, "EPD_0403_2015_RGN.csv", row.names = FALSE)